...
//            ->add('delivery', null, array('label' => ''))
            ...
            ->add('priceMasterSkzi', null, array('label' => 'Цена мастера. СКЗИ'))
            ->add('priceSaleMasterSkzi', null, array('label' => 'Цена мастера. СКЗИ (До скидки)'))
            ->add('priceMasterEstr', null, array('label' => 'Цена мастера. ЕСТР'))
            ->add('priceSaleMasterEstr', null, array('label' => 'Цена мастера. ЕСТР (До скидки)'))
            ->add('priceMasterRu', null, array('label' => 'Цена мастера. РФ'))
            ->add('priceSaleMasterRu', null, array('label' => 'Цена мастера. РФ (До скидки)'))

            ->add('priceEnterpriseSkzi', null, array('label' => 'Цена предпр. СКЗИ'))
            ->add('priceSaleEnterpriseSkzi', null, array('label' => 'Цена предпр. СКЗИ (До скидки)'))
            ->add('priceEnterpriseEstr', null, array('label' => 'Цена предпр. ЕСТР'))
            ->add('priceSaleEnterpriseEstr', null, array('label' => 'Цена предпр. ЕСТР (До скидки)'))
            ->add('priceEnterpriseRu', null, array('label' => 'Цена предпр. РФ'))
            ->add('priceSaleEnterpriseRu', null, array('label' => 'Цена предпр. РФ (До скидки)'))
