...
class UserEstrType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('birthDate', 'text',['label'=>'Дата рождения', 'attr' => ['class' => 'date'], 'date_widget' => 'single_text', 'format' =>'dd.mm.YYYY'])
            ...
            ->add('driverDocDateStarts', 'date' ,['label' => 'Дата выдачи', 'attr' => ['class' => 'date'], 'date_widget' => 'single_text', 'format' =>'dd.mm.YYYY'])
