<?php
namespace Learning\MainBundle\Controller;
...
//    public function showAssistAction(){ array}
    ...
    /**
     * @Route("/payment/assist", name="payment")
     * @Template("LearningMainBundle:Assist:redirect.html.twig")
     */
    public function PostAssistAction(Request $request){
     ...
     * @Secure(roles = "IS_UTHENTICATED_REMEBERED")
     */
