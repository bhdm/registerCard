...
//            }
            ...
            $user->setCopySignature2($this->getImgToArray($session->get('signFile')));
            $user->setCopySignature3($this->getImgToArray($session->get('signFile')));
            $user->setCopySignature4($this->getImgToArray($session->get('signFile')));
