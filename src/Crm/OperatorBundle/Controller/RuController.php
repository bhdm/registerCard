...
//        }
    ...
    /**
     * @Route("/add/{companyId}", name="operator_ru_add")
     * @Template()
     */
    ...
    /**
     * @Route("/edit/{companyId}/{userId}", name="operator_ru_edit")
     * @Template()
     */
    ...
    /**
     * @Route("/show/{userId}", name="operator_show_ru")
     * @Template()
     */
...
//                }
                ...
                return $this->redirect($this->generateUrl('operator_ru_list'));
    ...
    /**
     * @Route("/remove/{userId}", name="operator_ru_remove")
     * @Template()
     */
    ...
    /**
     * @Route("/enabled/{userId}", name="operator_ru_enabled")
     * @Template()
     */
    ...
    /**
     * @Route("/production/{userId}/{type}", name="operator_ru_production", defaults={"type"="true"})
     * @Template()
     */
